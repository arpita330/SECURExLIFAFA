...
<br>
            <center>
        <h1 style="font-weight:bold;">Flip the Coin</h1>
        <p class="balance">Balance: ₹<span id="balance"><?= $balance ?></span></p>

        <form id="betForm">
            <label for="betAmount" style="font-weight:bold;">Enter Bet Amount:</label>
            <input type="number" id="betAmount" min="10" max="500" class="w-full p-3 border border-gray-300 rounded-md placeholder-gray-400 font-bold" placeholder="Enter Bet Amount ( Min:10 / Max:500 )" required><br><br>
    ...
    <footer111 style="font-weight:bold;">Good Luck, <?= htmlspecialchars($Name) ?>!</footer1>
    <br></center><br>
</div><br><hr>
