...
<!--	<link rel="stylesheet" href="assets/css/sstyle.css"> -->
    ...
    <title>Add Funds ~ Pavan Cash Loot</title>
...
<body class="bg-gray-100">
    ...
    <div id="sidebar" class="sidebar">
        ...
        <ul>
            ...
            <li style="background-color: blue;"><i class="fas fa-plus"><a href="add_fund.php"></i>Recharge</a></li>
...
<font color='brown' style='font-weight:bold;'>Add Funds <i class='fas fa-plus-circle' ></i></font><br>

<br>
            <center> 
            <hr><br><div class="note-box">If you want to add funds to your PavanCashLoot.site account then you can contact our Telegram payment team Our team works<spam style="color:red;"> 24x7.</spam> अगर आपको फंड अपने PavanCashLoot.site अकाउंट में ऐड करना है तो आप हमारे टेलीग्राम पेमेंट टीम को कॉन्टैक्ट करें  हमारी टीम <spam style="color:red;">24x7</spam> काम करती हैै </div> <br><hr><br><a href='https://t.me/PavanCashLootSupport'><button class='submit'  style='font-weight:bold;'>Click Here  <i class='bx bx-send' ></i></button></a><br></center><br>
</div><br><hr>
</span>
...
<div class="w-full p-6">
  ...
  <!-- Footer Section -->
    ...
    <br>    <div class="footer-bottom" style="font-weight: bold;">
