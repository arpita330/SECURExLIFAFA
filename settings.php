...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if (isset($_POST['update_profile'])) {
        // Update profile in the users.json file
        foreach ($users as &$usr) {
            if ($usr['number'] == $_SESSION['number']) {
                $usr['name'] = htmlspecialchars($_POST['name']);
                $usr['email'] = htmlspecialchars($_POST['email']);
                $usr['phone'] = htmlspecialchars($_POST['phone']);
                $user = $usr;
                break;
            }
        }
    ...
    if (isset($_POST['change_password'])) {
        // Change password in the users.json file
        ...
        if ($new_password === $confirm_password) {
            foreach ($users as &$usr) {
                if ($usr['number'] == $_SESSION['number']) {
                    $usr['password'] = password_hash($new_password, PASSWORD_BCRYPT);
                    break;
                }
            }
            file_put_contents($file, json_encode($users, JSON_PRETTY_PRINT));
...
<!--	<link rel="stylesheet" href="assets/css/sstyle.css"> -->
    ...
    <title>Settings ~ Pavan Cash Loot</title>
...
<body class="bg-gray-100">
    ...
    <div id="sidebar" class="sidebar">
        ...
        <ul>
            ...
            <li style="background-color: blue;"><i class="fas fa-gear"></i> <a href="settings.php"></i>Settings</a></li>
...
<font color='brown' style='font-weight:bold;'>Update Settings <i class="fas fa-user-cog"></i></font><br>
...
<br>
             ...
             <font style="font-weight:bold"> 
                <form method="POST" action="">
                    <div class="mb-3">
                        <label for="name" class="form-label" style='font-weight:bold; color:red;'>Name:</label>
                        <input type="text" name="name" id="name" class="form-control" style ="  padding: 10px;
  border: 1px solid #ddd;
  border-radius: 8px;
  width: 100%;
  margin-top: 8px;
  ...
  background-color: #fff;
  color: #333;
  transition: border 0.3s ease-in-out;"value="<?= htmlspecialchars($user['name']); ?>" required>
                    </div>
                    <div class="mb-3">
                        <label for="email" class="form-label" style='font-weight:bold; color:red;'>Email:</label>
                        <input type="email" name="email" id="email" class="form-control" style ="  padding: 10px;
  border: 1px solid #ddd;
  border-radius: 8px;
  width: 100%;
  margin-top: 8px;
  ...
  background-color: #fff;
  color: #333;
  transition: border 0.3s ease-in-out;"value="<?= htmlspecialchars($user['email']); ?>" required>
                    </div>
                    <div class="mb-3">
                        <label for="phone" class="form-label" style='font-weight:bold; color:red;'>Phone:</label>
                        <input type="text" name="phone" id="phone" class="form-control" style="  padding: 10px;
  border: 1px solid #ddd;
  border-radius: 8px;
  width: 100%;
  margin-top: 8px;
  ...
  background-color: #fff;
  color: #333;
  transition: border 0.3s ease-in-out;" value="<?= htmlspecialchars($user['phone']); ?>" required>
                    </div>
                    <center>
                   <br> <button class="submit" name="update_profile" style='font-weight:bold;'>Update Profile</button>
                </form>
            </center><br>
</div><br><hr>
...
<font color='brown' style='font-weight:bold;'>Change Password <i class="bx bxs-bar-chart-alt-2"> </i></font><br>

<br>
            
                                <form method="POST" action="">
                    <div class="mb-3">
                        <label for="current_password" class="form-label" style='font-weight:bold; color:red;'>Current Password:</label>
  ...
  background-color: #fff;
  color: #333;
  transition: border 0.3s ease-in-out;" required>
                    </div>
                    <div class="mb-3">
                        <label for="new_password" class="form-label" style='font-weight:bold; color:red;'>New Password:</label>
                        <input type="password" name="new_password" id="new_password" class="form-control" style="  padding: 10px;
  border: 1px solid #ddd;
  border-radius: 8px;
  width: 100%;
  margin-top: 8px;
  ...
  transition: border 0.3s ease-in-out;"  required>
                    ...
                    <div class="mb-3">
                        <label for="confirm_password" class="form-label" style='font-weight:bold; color:red;'>Confirm New Password:</label>
                        <input type="password" name="confirm_password" id="confirm_password" class="form-control" style="  padding: 10px;
  border: 1px solid #ddd;
  border-radius: 8px;
  width: 100%;
  margin-top: 8px;
  ...
  transition: border 0.3s ease-in-out;"  required>
                  ...
                  <center> <button class="submit" name="change_password" style='font-weight:bold;'>Change Password</button></center>
                </form>
            <br></div>
