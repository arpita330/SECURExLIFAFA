...
if(file_exists("dicelifs/$lid/count.txt")){
$conts=file_get_contents("dicelifs/$lid/count.txt");
$contss=$conts+$puser;
}
else{
    $conts=file_get_contents("dicelifs/$lid/count.txt");
...
<center><br><br>
<img src="assets/dice/'.$r.'.png" width="100px"></center><br><br><font size="4" color="red" style="font-weight:600">BETTER LUCK NEXT TIME...!</font><br>
...
echo'<audio autoplay="autoplay" src="https://jydlifafa.xyz/limages/Congo.mp3">
  ...
  <center><div style="margin-top:10px; border-top: 3px solid blue; border-right: 3px solid blue; border-bottom: 3px solid blue; border-left: 3px solid blue;  border-radius: 3px; padding: 10px;"><b>
  <font size="4" style="font-weight:600" >
  <font color="red" size="4">'.$count.'</font><font color="Blue" size="4">/</font><font color="Green" size="4">'.$nuser.'</font> User Claimed</div></div>
        </font></center>';


$msgt='❌ *WRONG PREDICTION* ❌
...
file_put_contents("dicelifafa/claim/$id/$num.txt",$claim6);
   ...
   $ip=$_SERVER['REMOTE_ADDR'];
mkdir("Alifs/$lid/ip/$ip/loss.json");
         if($uid)
         
       {
        ...
        file_put_contents("Alifs/$lid$paytm.loss.json",loss);
file_put_contents("Alifs/$lid/ip/$ip.txt",loss);
       if($uid)
...
<input type="hidden" id="lidlid" value="thOke">
<br><center>
<b><font color="red" style="font-size:18px;">💥 Congrats... 💥</font></b><br><br>
<center><br><br>
<img src="assets/dice/'.$r.'.png" width="100px"></center><br><br><font size="4" style="font-weight:600"><br>You have won <font color="green">₹'.$puser.' Paytm Cash</font>, Successfully sent to <font color="green">'.$paytm.'</font><br>
<meta http-equiv="refresh" content="10;url='.$rlink.'"><br>
...
echo'<audio autoplay="autoplay" src="https://jydlifafa.xyz/limages/Congo.mp3">
  ...
  <center><div style="margin-top:10px; border-top: 3px solid blue; border-right: 3px solid blue; border-bottom: 3px solid blue; border-left: 3px solid blue;  border-radius: 3px; padding: 10px;">
  <font size="4" style="font-weight:600" >
  <font color="red" size="4">'.$contss.'</font><font color="Blue" size="4">/</font><font color="Green" size="4">'.$nuser.'</font> User Claimed</div></div>
        </font></center>';
echo'<audio autoplay="autoplay" src="https://jydlifafa.xyz/limages/Congo.mp3">
 	  	<div id="simpleToast">
  <i class="fas fa-exclamation-triangle"></i><span id="message"></span>
...
$ord="$less$nunn";
 $link="https://kunnicampaign.xyz/pay.php?mid=VTFVMVJWWlJQVDA9&mkey=17E56F7F28VV89V&amount=$puser&mob=$paytm&comment=$comment&type=Dice_Lifafa_Claim";
  setcookie('lifafano',$paytm,time()+60*30);
  setcookie('lifafatgid',$uid,time()+60*30);
...
$msgt5='🏆 *USER CLAIMED DICE LIFAFA* 🏆
