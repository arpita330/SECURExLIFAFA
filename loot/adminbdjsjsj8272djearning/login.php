...
<div id='loginbox'>
     <div style='padding:10px; width:100%; background: Azure; border-top:3px solid blue; border-right:3px solid blue; border-bottom:3px solid blue; border-left:3px solid blue; border-radius:10px;'><br>
 <center>    
