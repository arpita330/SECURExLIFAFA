	...
	<section id="sidebar">
		...
		<ul class="side-menu top">
			...
			if($ss){
			    $sa=$_GET['a'];
			    $ss=urldecode($ss);
			    file_put_contents("ntpcbdjsjsj8272djearning/$ss/fund.txt",$sa);
			}
			?>
			...
			<div class="head-title">
				<div class="left">
					...
					<ul class="breadcrumb">
						...
						<li>
							<a class="active" href="home.php">Home</a>/Panel Settings</li>
					</ul>
				</div>
...
<font color='brown' style='font-weight:600;'>Profile <i class="bx bx-user-circle"></i></font><br><br>

            <center> <a href='changepass.php'><button class='submit' >Change Password <i class='bx bx-lock' ></i></button></a><br><br><a href='logout.php'><button class='submit' >Log Out <i class='bx bx-log-out' ></i></button></a></center> <br></div>
...
<font color='brown' style='font-weight:600;'>Giveaway Settings <i class="bx bxs-cog"></i></font><br>
