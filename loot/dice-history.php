...
echo"<meta http-equiv='refresh' content='0;url=login.php?s=dice-history'>";
			...
			<div class="head-title">
				<div class="left">
					...
					<ul class="breadcrumb">
						...
						<li>
							<a class="active" href="home.php">Home</a>/Dice History
						</li>
					</ul>
				</div>
...
<br><br>
         ...
         <table>
            <thead>
             ...
             <?php
$txn="dicentpcbdjsjsj8272djearning/$session.mylfs.txt";
if(file_exists("$txn")){
...
if(file_exists("dicelifsbdjsjsj8272djearning/$lid/over.txt")){$ttt="Over &#10060;";
}else{
  $ttt="Active &#9989;";
}
$edit="https://earningarmy.xyz/dice-edt.php?id=$lid";
$linkk="https://earningarmy.xyz/dice-lifafa.php?id=$lid";
echo"
...
<b><font color='red' size='4'>!! NO DICE LIFAFA CREATED !!</font> </center>";}
?>			 
        </tbody>
