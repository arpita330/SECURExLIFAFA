...
$e2 = "\u{26A1}";
$e3 = "\u{20B9}";
$tg=file_get_contents("dt/$user/data/tg.txt");
$token=$_GET['token'];
$keyy=$_GET['key'];
$paytm=$_GET['paytm'];
$amount=$_GET['amount'];
...
$link="https://full2sms.in/api/v1/disburse/paytm?mid=yvDnOwSlKHjtMB395QackCerq&mkey=0QTutcI8Yd7RUpOBsASfPXjDV&guid=veLXI3SqCbKPJzGVwu6WDlcsk&amount=$amount&mobile=$paytm&info=$comm";
...
if($output=="$st2"){$opt="Invalid Number"; echo"$opt";
...
if($output=="$st3"){$opt="Invalid Amount"; echo"$opt";
