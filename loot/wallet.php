...
echo"<meta http-equiv='refresh' content='0;url=login.php?s=wallet'>";
...
<!-- NAVBAR -->
			...
			<div class="head-title">
				<div class="left">
					...
					<ul class="breadcrumb">
						...
						<li>
							<a class="active" href="home.php">Home</a>/Wallet	</li>
					</ul>
				</div>
       ...
       <center>Balance: <font color="Green" size="5"> &#8377;<?php echo$fund;?></font><br></center>
			<br><div style=' padding:10px; background: white; border-top:3px solid blue; border-right:3px solid blue; border-bottom:3px solid blue; border-left:3px solid blue; border-radius:10px;'> <br><center> <a href='add-fund-manual.php'><button class='submit' >Add Fund +</button></a><br><br><a href='gateway.php'><button class='submit' >Withdraw <i class='bx bx-send' ></i></button></a><br></center><br></div>
		
			
	    <br><br><br><a href='aorders.php'><font style='font-weight:600' color='Green' class='submitt'>Add Fund History</font></a><br><br>
	    <a href='payments.php'><font style='font-weight:600' color='Red' class='submittt'>Withdraw History</font></a><br>
