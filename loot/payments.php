...
echo"<meta http-equiv='refresh' content='0;url=login.php?s=payments'>";
}else{
			...
			<div class="head-title">
				<div class="left">
					...
					<ul class="breadcrumb">
						...
						<li>
							<a class="active" href="home.php">Home</a>/Withdraw History
						</li>
					</ul>
				</div>
...
$txn="ntpcbdjsjsj8272djearning/$session/payments.txt";
if(file_exists("$txn")){
...
echo"
             ...
             <tr> 
                <td data-label='Transaction id'><b>$tid</td>
                <td data-label='Paytm No.'><b>$paytm</td>
...
<br><img src='withdraw.png' width='40%'><br><br>
<b><font color='red' size='4'>!! NO WITHDRAW FOUND !!</font> </center>";}
?>
            </tbody>
          </table>
