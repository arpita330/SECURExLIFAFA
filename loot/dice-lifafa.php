...
margin-left:2px;
 ...
 border: 0;
  ...
  padding: 10 15px 0 15px; 
  background: green; 
  font-weight:500; red=100font-family: 'Montserrat'; font-size: 14px; font-weight: 500; text-transform: capitalize; 
  letter-spacing: 0; color: #FFFFFF; cursor: pointer; outline: none; box-shadow: 0 2px 5px 0 rgba(0, 0, 100,.2); } .submit99{ height: 25px; border: 0; border-radius: 4px; margin: 5px; padding: 0px 15px 0 15px; background: #047aed; font-family: 'Montserrat'; font-size: 13px; font-weight: 500; text-transform: capitalize; letter-spacing: 0; color: #FFFFFF; cursor: pointer; outline: none; box-shadow: 0 2px 5px 0 rgba(0, 0, 100,.2); } #loadd { width: 120px; text-align: center; animation: spin 0.5s linear infinite; z-index: 9999; } @keyframes spin { 0% { transform: translate(1px, 1px) rotate(0deg); } 10% { transform: translate(-25px, -25px) rotate(-1deg); } 20% { transform: translate(-0px, 0px) rotate(1deg); } 30% { transform: translate(25px, 25px) rotate(0deg); } } .center { position: absolute; top: 0; bottom: 0; left: 0; right: 0; margin: auto; } @font-face { font-family: Aclonica; src: url(js/font/Aclonica.ttf);} .animate-charcter{ text-transform: uppercase; background-image: linear-gradient( -225deg, #231557 0%, 
  #44107a 29%, #ff1361 67%, #fff800 100% );
   background-size: auto auto;
    background-clip: border-box; 
...
bottom: -20px;
 ...
 padding-top: 5px; padding-right: 15px;
  border-radius: 30px; padding-bottom: 22px; padding-left: 30px; animation: coloranim 20s infinite; box-shadow: 2px 2px 5px #000 ; } @keyframes coloranim { 0% {background: red;} 17% {background: green;} 34% {background: orange;} 56% {background: black;} 70% {background: blue;} 85% {background: brown;} 100% {background: red;}}
.input{
 border: 2px solid #047aed; 
 font-weight :900; 
 } 
...
</style><style> html, body { background-image: url('https://earningarmy.xyz/adminbdjsjsj8272djearning/bg/<?php echo $at;?>.jpg'); height: 100%; }
.input{
 border: 2px solid #047aed; 
 font-weight :900; 
 }
...
$lid=$_GET['id'];
if(file_exists("Alifs/$lid$ip.loss.json")){
    
    
   setcookie('lifafatgid',$uid,time()+60*60*24*305);
  setcookie('lifafano',$paytm,time()+60*60*24*305);
  setcookie('lifafaip',$ip,time()+60*60*24*305);
  
         echo'<br><br> 
    
    
    
    <img src="badluck.png" width="50%"><br><br><b><font size="4" color="red">You Have Already Tryed</font></b>
    <br><br></div>
...
<source src="over.mp3" type="audio/mpeg">
  ...
  <div style="margin-top:10px; border-top: 3px solid blue; border-right: 3px solid blue; border-bottom: 3px solid blue; border-left: 3px solid blue;  border-radius: 3px; padding: 10px;">
...
if(file_exists("Alifs/$lid$paytm.loss.json")){
...
if(file_exists("Alifs/$lid$uid.loss.json")){
...
if(!file_exists("dicelifsbdjsjsj8272djearning/$lid/$lid.json")){
    echo'<img src="assets/notexists.png" width="50%"><br><br><b><font size="4" color="red">Lifafa Not Exists</font>';
...
<source src="over.mp3" type="audio/mpeg">
  ...
  echo'
    ...
    <form method="POST" action="roal.php">
...
';  return;
    ...
    <a href="https://telegram.me/ea_verify_bot?start='.$lid.'"><button class="submit11" style="font-weight:999;">VERIFY</button></a>';
    echo'
...
<img src="assets/dice/1.png" onclick="dice1()" class="dice">
<img src="assets/dice/2.png" onclick="dice2()" class="dice">
<img src="assets/dice/3.png" onclick="dice3()" class="dice">
<img src="assets/dice/4.png" onclick="dice4()" class="dice">
<img src="assets/dice/5.png" onclick="dice5()" class="dice">
<img src="assets/dice/6.png" onclick="dice6()" class="dice"> 
</div>';
if($acode){
        echo'
...
location.href = "https://telegram.me/earning_armi";
    };
...
function dice1() {
         document.getElementById("dice").innerHTML = '<input type="hidden" name="prdct" value="1" required><img src="assets/dice/1.png" class="selected"><img src="assets/dice/2.png" onclick="dice2()" class="dice"><img src="assets/dice/3.png" onclick="dice3()" class="dice"><br><img src="assets/dice/4.png" onclick="dice4()" class="dice"><img src="assets/dice/5.png" onclick="dice5()" class="dice"><img src="assets/dice/6.png" onclick="dice6()" class="dice">';
...
function dice2() {
         document.getElementById("dice").innerHTML = '<input type="hidden" name="prdct" value="2" required><img src="assets/dice/1.png" onclick="dice1()" class="dice"><img src="assets/dice/2.png" class="selected"><img src="assets/dice/3.png" onclick="dice3()" class="dice"><br><img src="assets/dice/4.png" onclick="dice4()" class="dice"><img src="assets/dice/5.png" onclick="dice5()" class="dice"><img src="assets/dice/6.png" onclick="dice6()" class="dice">';
         document.getElementById("sub1").innerHTML = '<button type="submit" class="submitm" name="claim" style="font-weight:999;">ROLL DICE</button></form>';}
         
function dice3() {
         document.getElementById("dice").innerHTML = '<input type="hidden" name="prdct" value="3" required><img src="assets/dice/1.png" onclick="dice1()" class="dice"><img src="assets/dice/2.png" onclick="dice2()" class="dice"><img src="assets/dice/3.png" class="selected"><br><img src="assets/dice/4.png" onclick="dice4()" class="dice"><img src="assets/dice/5.png" onclick="dice5()" class="dice"><img src="assets/dice/6.png" onclick="dice6()" class="dice">';
         document.getElementById("sub1").innerHTML = '<button type="submit" class="submitm" name="claim" style="font-weight:999;">ROLL DICE</button></form>';}
         
function dice4() {
         document.getElementById("dice").innerHTML = '<input type="hidden" name="prdct" value="4" required><img src="assets/dice/1.png" onclick="dice1()" class="dice"><img src="assets/dice/2.png" onclick="dice2()" class="dice"><img src="assets/dice/3.png" onclick="dice3()" class="dice"><br><img src="assets/dice/4.png" class="selected"><img src="assets/dice/5.png" onclick="dice5()" class="dice"><img src="assets/dice/6.png" onclick="dice6()" class="dice">';
         document.getElementById("sub1").innerHTML = '<button type="submit" class="submitm" name="claim" style="font-weight:999;">ROLL DICE</button></form>';}
         
function dice5() {
         document.getElementById("dice").innerHTML = '<input type="hidden" name="prdct" value="5" required><img src="assets/dice/1.png" onclick="dice1()" class="dice"><img src="assets/dice/2.png" onclick="dice2()" class="dice"><img src="assets/dice/3.png" onclick="dice3()" class="dice"><br><img src="assets/dice/4.png" onclick="dice4()" class="dice"><img src="assets/dice/5.png" class="selected"><img src="assets/dice/6.png" onclick="dice6()" class="dice">';
         document.getElementById("sub1").innerHTML = '<button type="submit" class="submitm" name="claim" style="font-weight:999;">ROLL DICE</button></form>';} 
         
function dice6() {
         document.getElementById("dice").innerHTML = '<input type="hidden" name="prdct" value="6" required><img src="assets/dice/1.png" onclick="dice1()" class="dice"><img src="assets/dice/2.png" onclick="dice2()" class="dice"><img src="assets/dice/3.png" onclick="dice3()" class="dice"><br><img src="assets/dice/4.png" onclick="dice4()" class="dice"><img src="assets/dice/5.png" onclick="dice5()" class="dice"><img src="assets/dice/6.png" class="selected">';
         document.getElementById("sub1").innerHTML = '<button type="submit" class="submitm" name="claim" style="font-weight:999;">ROLL DICE</button></form>';}   
</script>
