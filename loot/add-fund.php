...
echo"<meta http-equiv='refresh' content='0;url=login.php?s=add-fund'>";
			...
			<div class="head-title">
				<div class="left">
					...
					<ul class="breadcrumb">
						...
						<li>
							<a class="active" href="home.php">Home</a>/Add Fund [Instant]
						</li>
					</ul>
				</div>
...
<center><font style="font-weight:300"><b><font color="Red"> Charge:- 2%<br><br><font color="Blue"> You have to Pay <font color="Green">₹<a  name="payamo" id="amotopay"></b></font></font></font></font><br>
            <form method="GET" action="pay.php" autocomplete="off"><input type="number" class="input" min="10" placeholder="Enter Amount" id="amo" name="amo" value=""oninput="myFunction()"required>
...
<br></div>
	...
	<br><br><br><br><br><br><br><br>
									...
									<div class="text-center">
									  <img class=" me-lg-2" src="safe.png" alt="" style="width: 100px; height: 25px;">
									  </div>    
