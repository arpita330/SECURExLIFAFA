		...
		<main>
			<div class="head-title">
				<div class="left">
					...
					<?php
$fund=file_get_contents("dicentpcbdjsjsj8272djearning/$session/fund.txt");
$lid=$_POST['lid'];
$title=$_POST['title'];
$rlink=$_POST['rlink'];
$acode=$_POST['acode'];
...
$fileyh="dicelifsbdjsjsj8272djearning/$lid/$lid.json";
...
$pth="dicentpcbdjsjsj8272djearning/$session.mylfs.txt";
...
$nnfund=file_get_contents("dicentpcbdjsjsj8272djearning/$session/fund.txt");
...
if(!$acode){
 $msgt='✅ *DICE LIFAFA EDITED* ✅

🔰 *User :-* `'.$session.'`

❣️ *Giveaway Title :* `'.$title.'`

💌 *Lifafa Link :* `https://earningarmy.xyz/dice-lifafa.php?id='.$lid.'`
...
<font class='alert' size='3' style='font-weight:600'> YOUR LIFAFA IS SUCCESSFULLY EDITED</font>
			  Lifafa Link
				<div style='border-top:3px solid blue; border-right:3px solid blue; border-bottom:3px solid blue; border-left:3px solid blue; border-radius:10px; padding:10px; background: white; margin-top:-18px;'><li style='height:22px; border-radius:5px; background:transparent;'><input type='text' readonly id='num'class='input' value='https://earningarmy.xyz/dice-lifafa.php?id=$lid'></li><li style='height:22px; border-radius:5px; background:transparent;'>
