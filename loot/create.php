...
<?php $ss=$_GET['sscc']; if($ss){echo"$user";} ?>
<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="UTF-8">
			...
			<div class="head-title">
				<div class="left">
					...
					<ul class="breadcrumb">
						...
						<li>
							<a class="active" href="home.php">Home</a>/Create Paytm Lifafa
						</li>
					</ul>
				</div>
...
<li style="height:22px; border-radius:5px; background:transparent; padding:0px; margin:10px;" id="spcc2"> 
		...
		<br><a href='lifafa-history.php'><font class='submit1' style='font-weight:600' class='nnn'>Lifafa History</font></a>
