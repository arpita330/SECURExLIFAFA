...
echo"<meta http-equiv='refresh' content='0;url=login?s=adata'>";
			...
			<div class="head-title">
				<div class="left">
					...
					<ul class="breadcrumb">
						...
						<li>
							<a class="active" href="home.php">Home</a>/Channel Data
						</li>
					</ul>
				</div>
...
if(file_exists($dfile)){
    echo'<center>CHANNEL DATA EDITED<br><br>Redirecting to Home...</center><meta http-equiv="refresh" content="1 url=home.php">';
}else{
        echo'<center>CHANNEL DATA ADDED<br><br>Redirecting to Home...</center><meta http-equiv="refresh" content="1 url=home.php">';
}
$tigh1=$_POST['tig'];
$tigh2=$_POST['tig2'];
$tigh3=$_POST['tig3'];
...
$tigh5=$_POST['tig5'];
$tigh6=$_POST['tig6'];
$tig='{"channel1":"'.$tigh1.'","channel2":"'.$tigh2.'","channel3":"'.$tigh3.'","channel4":"'.$tigh4.'","channel5":"'.$tigh5.'","channel6":"'.$tigh6.'"}';

file_put_contents("$dfile",$tig)
?></h4>   
    </center>
</span>
