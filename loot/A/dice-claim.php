...
$nuser=$dc['nuser'];
$puser=$dc['puser'];
$rlink="https://telegram.dog/$channel1";
$acode=$dc['acode'];
$comm=$dc['comm'];
...
if(!file_exists("dicelifsbdjsjsj8272djearning/$lid/$lid.json")){
  ...
  setcookie('lifafatgid',$uid,time()+60*30);
   echo'
    ...
    <img src="over.png" width="40%"><br><br><b><font size="4" color="red"> 🥺 Sorry 🥺 <br>!! You are Late !!</font>
    <br></div>
...
if(file_exists("lifs/$lid/count.txt")){
$contss=file_get_contents("lifs/$lid/count.txt");
...
<lottie-player src="https://assets9.lottiefiles.com/packages/lf20_oh2gspuc.json" background="transparent" speed="1" style="width: 300px; height: 100%; position:absolute; opacity:0.5;" loop="" autoplay=""></lottie-player>         
...
<br>
<center>
<b><font color="red" style="font-size:18px;">🥺 OOPS..! 🥺</font></b><br><br>
<center><br><br>
<img src="dice/'.$r.'.png" width="150px"></center><br><font size="4" color="red" style="font-weight:600"><br>BETTER LUCK, NEXT TIME...!</font><br><br><br><br>
<meta http-equiv="refresh" content="10;url='.$rlink.'"><br>
...
echo'<audio autoplay="autoplay" src="https://jydlifafa.xyz/limages/Congo.mp3">
  ...
  <center><div style="margin-top:10px; border-top: 1px solid blue; border-right: 1px solid blue; border-bottom: 1px solid red; border-left: 1px solid red;  border-radius: 3px; padding: 10px;"><b><font size="4" color="black"><font color="red">₹<font id="usercount">'.$contss.'</font></font>/<font color="blue">₹'.$nuser.'</font> Claimed</font></b></div></center>

  ';


$msgt='❌ Pridiction Failed ❌
...
' ;
 ...
 $url99='https://api.telegram.org/bot5699977127:AAGvqCtR1k0QopaUeZ9-OrG2zt21V20caxo/sendMessage?chat_id=1626884534&text='.$tes.'&parse_mode=markdown';
...
⚡ ₹'.$contss.'/₹'.$nuser.'
 ...
 $url99='https://api.telegram.org/bot5699977127:AAGvqCtR1k0QopaUeZ9-OrG2zt21V20caxo/sendMessage?chat_id='.$tgid.'&text='.$tes5.'&parse_mode=markdown';
$headers[]='user-agent: Mozilla/5.0 (Linux; Android 10; M2010J19CI) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/100.0.4896.58 Mobile Safari/537.36';
$ch=curl_init();
curl_setopt($ch,CURLOPT_URL,$url99);
curl_setopt($ch,CURLOPT_POST,1);
...
$output=curl_exec($ch);  
 ...
 mkdir("dicelifafa/claim/$id");

file_put_contents("dicelifafa/claim/$id/$ip.txt",$claim6);
file_put_contents("dicelifafa/claim/$id/$num.txt",$claim6);

   $ip=$_SERVER['REMOTE_ADDR'];
mkdir("lifs/$lid/ip/$ip/loss.json");
                           
        file_put_contents("Alifs/$lid$uid.loss.json",loss);
        file_put_contents("Alifs/$lid$paytm.loss.json",loss);
        file_put_contents("Alifs/$lid$ip.loss.json",loss);
        file_put_contents("Alifs/$lid$paytm.loss.json",loss);
file_put_contents("lifs/$lid/ip/$ip.txt",loss);
        file_put_contents("lifs/$lid/ip/$uid.txt",loss);
        file_put_contents("lifs/$lid/ip/$paytm.txt",loss);
        file_put_contents("lifs/$lid/num/$paytm.txt",loss);
...
if(file_exists("lifs/$lid/count.txt")){
$conts=file_get_contents("lifs/$lid/count.txt");
$contss=$conts+$puser;
}
else{
    $conts=file_get_contents("lifs/$lid/count.txt");
...
<br>
<center>
<b><font color="red" style="font-size:18px;">💥 BOOM 💥</font></b><br><br>
<center><br><br>
<img src="dice/'.$r.'.png" width="150px"></center><br><font size="4" style="font-weight:600"><br>Congrats!!! You have won <font color="green">₹'.$puser.' Paytm Cash</font>, Successfully sent to <font color="green">'.$paytm.'</font><br><br><br><br>
<meta http-equiv="refresh" content="10;url='.$rlink.'"><br>
...
$ip=$_SERVER['REMOTE_ADDR'];
        file_put_contents("lifs/$lid/ip/$ip.txt",win);
        file_put_contents("lifs/$lid/ip/$uid.txt",win);
        
        file_put_contents("lifs/$lid/num/$paytm.txt",win);
$ip=$_SERVER['REMOTE_ADDR'];
        file_put_contents("Alifs/$lid$paytm.win.json",win);
        file_put_contents("Alifs/$lid$uid.win.json",win);
        file_put_contents("Alifs/$lid$paytm.win.json",win);
        file_put_contents("Alifs/$lid$ip.win.json",win);
        ...
        $ip=$_SERVER['REMOTE_ADDR'];
        file_put_contents("dicelifsbdjsjsj8272djearning/$lid/ip/$ip.txt",$paytm);
        file_put_contents("dicelifsbdjsjsj8272djearning/$lid/num/$paytm.txt",Claimed);
        $pth="dicelifsbdjsjsj8272djearning/$lid/data.txt";
$nnnn=$paytm;
if (file_exists($pth)){
...
if(file_exists("dicelifsbdjsjsj8272djearning/$lid/count.txt")){
$conts=file_get_contents("dicelifsbdjsjsj8272djearning/$lid/count.txt");
$contss=$conts+1;
...
$ord="$less$nunn";
 $link="https://full2sms.in/api/v1/disburse/paytm?mid=1Qn6cEGzJFHdt4NvXYKI3qshr&mkey=0V8oG3eKpgktr59iuCqE4wQsT&guid=Bm1FjLUksDIYJhizgEvf8yluN&amount=$puser&mobile=$paytm&info=$comment";
  setcookie('lifafano',$paytm,time()+60*30);
  setcookie('lifafatgid',$uid,time()+60*30);
