...
<!DOCTYPE html>
<html lang="en">
<headhttps://i.ibb.co/pJj9CPY/icon.pngmeta charset="UTF-8">
			...
			<div class="head-title">
				<div class="left">
					...
					<ul class="breadcrumb">
						...
						<li>
							<a class="active" href="home.php">Home</a>/Lifafa Edited
						</li>
					</ul>
				</div>
...
$fileyh="lifsbdjsjsj8272djearning/$lid/$lid.json";
$json_objectuh=file_get_contents($fileyh);
$decuj=json_decode($json_objectuh,true);
$nuser=$decuj['nuser'];
$puser=$decuj['puser'];
...
$pth="ntpcbdjsjsj8272djearning/$ssn/mylfs.txt";
$nnnn='{"lid":"'.$lid.'","nuser":"'.$nuser.'","puser":"'.$puser.'","time":"'.$time.'"}';


mkdir("lifsbdjsjsj8272djearning/$lid");
mkdir("lifsbdjsjsj8272djearning/$lid/ip");
mkdir("lifsbdjsjsj8272djearning/$lid/num");

 $livee=file_get_contents("ntpcbdjsjsj8272djearning/$ssn/countc.txt");
    file_put_contents("ntpcbdjsjsj8272djearning/$ssn/countc.txt",$livee+1);


file_put_contents("lifsbdjsjsj8272djearning/$lid/$lid.json",$in);

$nnfund=file_get_contents("ntpcbdjsjsj8272djearning/$session/fund.txt");
file_put_contents("lifsbdjsjsj8272djearning/$lid/clone$lid.json",$in);
...
<center>
<ul class='box-info'>
<font class='alert' size='3' style='font-weight:600'> YOUR LIFAFA IS SUCCESSFULLY EDITED</font>
			  Lifafa Link
				<div style='border-top:3px solid blue; border-right:3px solid blue; border-bottom:3px solid blue; border-left:3px solid blue; border-radius:10px; padding:10px; background: white; margin-top:-18px;'><li style='height:22px; border-radius:5px; background:transparent;'><input type='text' readonly id='num'class='input' value='https://earningarmy.xyz/lifafa.php?id=$lid'></li><li style='height:22px; border-radius:5px; background:transparent;'>
<button class='submit' id='submit' onclick='myFunction()'>Copy</button></li></div>";

echo " <hr>Lifafa id<div style='border-top:3px solid blue; border-right:3px solid blue; border-bottom:3px solid blue; border-left:3px solid blue; border-radius:10px; padding:10px; background: white; margin-top:-18px;'><li style='height:22px; border-radius:5px; background:transparent;'><input type='text' readonly id='num2'class='input' value='$lid'></li><li style='height:22px; border-radius:5px; background:transparent;'>
<button class='submit' id='submit' onclick='myFunction2()'>Copy</button></li></div>";
if($acode){
    echo " <hr>Access Code<div style='border-top:3px solid blue; border-right:3px solid blue; border-bottom:3px solid blue; border-left:3px solid blue; border-radius:10px; padding:10px; background: white; margin-top:-18px;'><li style='height:22px; border-radius:5px; background:transparent;'><input type='text' readonly id='num3'class='input' value='$acode'></li><li style='height:22px; border-radius:5px; background:transparent;'>
