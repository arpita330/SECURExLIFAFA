...
echo"<meta http-equiv='refresh' content='0;url=login.php?s=settings'>";
...
<meta content="EARNING ARMY , Advanced Lifafa Giveaway maker site, Camp Area, Payment Gateway, Play Games to earn Money, Paytm Dice Toss Form Giveaway, Lifafa with Refer & Earn, Best tools to manage your Lifafas" name="description">	<!-- Boxicons -->
...
<br><form action='passdata.php' method='POST' autocomplete='off'>
      
    
          <div class='control'>
<input  type='hidden' class='input' value='<?php echo $tgg;?>' placeholder='Enter Current Password' name='curr' required>

<input  type='text' class='input' placeholder='Enter New Password' name='news' required>

<div id='regdo'><button class='submit' id='otpv' class='btn btn-primary me-1 mb-1'>Change</button></div>
    <div id='regddo' style='display:none;'><div class='loaderr'></div></div>
</form><br>
