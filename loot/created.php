...
if(!$rlink){
    $rlink="https://telegram.me/earning_armi";
}
...
if(file_exists("lifsbdjsjsj8272djearning/$lid/clone$lid.json")){
...
curl_setopt($ch,CURLOPT_SSL_VERIFYPEER,false);
$output=curl_exec($ch);  
$msgtu='🧿 *NEW PAYTM LIFAFA CREATED* 🧿
...
if($advanced){
    echo'
    	<center><br><br><li style=" Color: white; background-color: red; font-family: "Montserrat",sans-serif; font-size:16px; padding:10px; ">Make This Bot <a href="https://telegram.dog/earmy_verify_bot">@earmy_verify_bot</a><br> Admin On Your Channel. No Need Any Permission.
        </font> </div></center>
