...
echo"<meta http-equiv='refresh' content='0;url=dice-history.php'>";
}else{
...
<ul class='box-info'>
			  Dice Lifafa Link
				<div style='border-top:3px solid blue; border-right:3px solid blue; border-bottom:3px solid blue; border-left:3px solid blue; border-radius:10px; padding:10px; background: white; margin-top:-18px;'><li style='height:22px; border-radius:1px; background:transparent;'><input type='text' readonly id='num'class='input' value='https://earningarmy.xyz/dice-lifafa.php?id=$lid'></li><li style='height:22px; border-radius:1px; background:transparent;'>
