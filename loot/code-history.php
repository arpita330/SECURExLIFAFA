...
echo"<meta http-equiv='refresh' content='0;url=login.php?s=code-history'>";
			...
			<div class="head-title">
				<div class="left">
					...
					<ul class="breadcrumb">
						...
						<li>
							<a class="active" href="home.php">Home</a>/Claim Code History
						</li>
					</ul>
				</div>
...
<br><br>
         ...
         <table>
            <thead>
             ...
             <?php
$txn="ntpcbdjsjsj8272djearning/$session/mycode.txt";
if(file_exists("$txn")){
...
$report="https://earningarmy.xyz/code-report.php?id=$lid";
echo"
            
            
             <tr> 
                <td data-label='Code'><b>$lid</b></td>
              
                <td data-label='Amount/User'><b>$puser/$nuser</b></td>
                 
                <td data-label='Claimed User'><a href='$report'><button class='submit'>View</button></a></td>
...
<br><img src='goal.png' width='60%'><br><br>
<b><font color='red' size='4'>!! NO CODE CREATED !!</font> </center>";}
?>			 
        </tbody>
