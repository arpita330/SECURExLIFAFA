...
if(file_exists("Alifs/$lid$ip.loss.json")){
  ...
  setcookie('lifafaip',$ip,time()+60*60*24*305);
    ...
    <img src="badluck.png" width="50%"><br><br><font size="4" color="red">You Have Already Tryed This Lifafa<br>!! </font>
    <br></div>
...
<source src="over.mp3" type="audio/mpeg">
  ...
  </a><font size="4" color="black"><font color="red">₹<font id="usercount">'.$count.'</font></font>/<font color="blue">₹'.$nuser.'</font> Claimed</font></b></div>
        </font> ';
        return;
...
if(!file_exists("lifsbdjsjsj8272djearning/$lid/$lid.json")){
    ...
    if($cc>=$nuser){
        file_put_contents("lifsbdjsjsj8272djearning/$lid/over.txt",over);
        echo'
...
<source src="over.mp3" type="audio/mpeg">
  ...
  <div style="font-size: 90%; border-top: 3px solid blue; border-right: 3px solid blue; border-bottom: 3px solid blue; border-left: 3px solid blue;  border-radius: 3px; padding: 10px;">
        ...
        $ip=$_SERVER['REMOTE_ADDR'];
    $ipfile="lifsbdjsjsj8272djearning/$lid/ip/$ip.txt";
...
';    
 ...
 {
 echo'
    <button type="submit" class="submit11" name="submit" style="font-weight:999;">CLAIM &#8377;'.$puser.'</button></form>';}
   if($advanced){
