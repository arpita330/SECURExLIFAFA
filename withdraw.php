...
<!--	<link rel="stylesheet" href="assets/css/sstyle.css"> -->
    ...
    <title>Withdraw ~ Pavan Cash Loot</title>
...
<font color='brown' style='font-weight:bold;'>Withdraw <i class='fas fa-wallet' ></i></font><br>

<br>
            <center> 
            <a href='pay_user.php'><button class='submit'  style='font-weight:bold;'>Pay On Wallet To Any User  <i class='bx bx-send' ></i></button></a><br>
            <br><hr><br><a href='pay_upi.php'><button class='submit'  style='font-weight:bold;'>Manual Pay Withdraw To Upi  <i class='bx bx-send' ></i></button></a><br>
     <!--       <br><hr><br><a href='#'><button class='submit'  style='font-weight:bold;'>Coming Soon...<i class='bx bx-send' ></i></button></a><br>
                        <br><hr><br><a href='#'><button class='submit'  style='font-weight:bold;'>Coming Soon...<i class='bx bx-send' ></i></button></a><br></center><br>
