...
<body class="bg-gray-100">
	...
	<section id="content" style="text-bold">
		...
		<main>
			<br>
                                     <br><hr>
		<br><div style=' padding:3px; background: white; border-top:3px solid Blue;border-right:5px solid blue;border-bottom:3px solid blue;border-left:3px solid blue; border-radius:10px;'>
		
       <hr><font style="font-weight:bold">
...
<br>
			...
			<br><div style=' padding:10px; background: white; border-top:3px solid Blue;border-right:3px solid Blue;border-bottom:3px solid Blue;border-left:3px solid Blue; border-radius:10px;'>
<font color='brown' style='font-weight:bold;'>Giveaway <i class="bx bxs-envelope"></i></font><br>
...
<font color='brown' style='font-weight:bold;'>Tools <i class="bx bxs-bar-chart-alt-2"> </i></font><br>
...
<br>
 ...
 <font color="blue" style="font-weight:600">
			<br><div style=' padding:10px; background: white; border-top:3px solid Blue;border-right:3px solid Blue;border-bottom:3px solid Blue;border-left:3px solid Blue; border-radius:10px;'>
<font color='brown' style='font-weight:bold;'>Admin Panel <i class='bx bxs-boad' ></i></font><br>

<br>
            <center> <br><a href='admin/index.php'><button class='submit'  style='font-weight:bold;'>Admin Panel<i class='bx bx-send' ></i></button></a><br></center><br>
</div><br><hr>
